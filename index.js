...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.94s4c.mongodb.net/?retryWrites=true&w=majority`;
...
async function run() {
    try {
        ...
        */
        ...
        //get booking data from indivisual login user
